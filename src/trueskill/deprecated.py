...
from . import DELTA, Rating, expose, global_env, quality_1vs1, rate_1vs1
...
def TrueSkill_transform_ratings(self, rating_groups, ranks=None, min_delta=DELTA):
    ...
    rating_groups = [(r,) if isinstance(r, Rating) else r for r in rating_groups]
...
def TrueSkill_rate_1vs1(self, rating1, rating2, drawn=False, min_delta=DELTA):
    ...
    """
    warnings.warn("Use global function rate_1vs1() instead", DeprecationWarning)
...
def TrueSkill_quality_1vs1(self, rating1, rating2):
    ...
    """
    warnings.warn("Use global function quality_1vs1() instead", DeprecationWarning)
